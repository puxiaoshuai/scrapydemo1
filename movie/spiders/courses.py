...
from movie.items import CourseItem
...
class MeijuSpider(scrapy.Spider):
    ...
    start_urls = ("https://www.shiyanlou.com/courses/?category=all&course_type=all&fee=all&tag=all&page={}".format(i) for i in range(1,23))
